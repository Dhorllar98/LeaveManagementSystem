...
namespace LeaveManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260907114649_AddAnnualLeaveResetTracking")]
    partial class AddAnnualLeaveResetTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeaveManagement.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LeaveManagement.Domain.Entities.LeaveRequest", b =>
                {
                    ...
                    b.Property<Guid?>("HandoverUserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LeaveManagement.Domain.Entities.NotificationSetting", b =>
                {
                    ...
                    b.Property<bool>("EnableLeaveStatusUpdateEmails")
                        .HasColumnType("boolean");

                    b.Property<bool>("EnableNewLeaveRequestEmails")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("LeaveManagement.Domain.Entities.Organization", b =>
                {
                    ...
                    b.Property<int>("DefaultAnnualLeaveDays")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LeaveManagement.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<int?>("LastLeaveResetYear")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LeaveManagement.Domain.Entities.Department", b =>
                {
                    b.HasOne("LeaveManagement.Domain.Entities.Organization", "Organization")
                        .WithMany()
            ...
            modelBuilder.Entity("LeaveManagement.Domain.Entities.LeaveRequest", b =>
                {
                    ...
                    b.HasOne("LeaveManagement.Domain.Entities.User", "HandoverUser")
                        .WithMany()
                        .HasForeignKey("HandoverUserId");
